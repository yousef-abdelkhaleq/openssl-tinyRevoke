...
BEGIN {
    ...
    require '/home/trexozz/thesis_rise/openssl-3.0.5/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/trexozz/thesis_rise/openssl-3.0.5/test/fips-and-base.cnf';
    shift;
